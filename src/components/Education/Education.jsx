  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute left-0 w-2 h-full transform -translate-x-1/2 bg-white sm:left-1/2 sm:-translate-x-0"></div>
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="absolute sm:left-1/2 left-0 transform translate-x-48 lg:translate-x-6 lg:-translate-y-3 translate-y-44 bg-gray-400 border-4 border-[#8245ec] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                {/* School Logo/Image */}
                <div className="w-40 h-20 rounded-md bg-0white ov2erflow-hidden">
                  <img
                    src={edu.img}
                    alt={edu.school}
